...
//			Debug.Log ("po : " + car1.transform.position);
			Debug.Log ("poo : " + GameObject.Find ("Coins5").transform.position);
		ran.transform.localPosition = car2.transform.position;
		if(timer >= 800)
		{
			timer = 0;
			ran.transform.position = car2.transform.position;
